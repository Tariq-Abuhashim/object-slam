...
int main(int argc, char **argv)
{
    if(argc < 5)
    {
		...
		cerr << endl << "./Examples/Stereo-Inertial/stereo_inertial_euroc Vocabulary/ORBvoc.txt Examples/Stereo-Inertial/EuRoC.yaml /home/mrt/dev/ORB_SLAM3/data/euroc/MH_01_easy Examples/Stereo-Inertial/EuRoC_TimeStamps/MH01.txt dataset-MH01_stereo " << endl;
        return 1;
    }
